...
1. **Med Bearbetningslicens** avses den licens Du tillämpar rörande Din Upphovsrätt och och Liknande Rättigheter när du bidrar till en Bearbetning enligt villkoren i denna Publika Licens.  
...
1. **Med Undantag och Begränsningar** avses "fair use", "fair dealing" och/eller varje annan form av undantag från eller inskränkningar i Upphovsrätt eller Liknande rättigheter som gäller för Din användning av Licensmaterialet.  

1. **Med Grundlicens** avses de licensegenskaper som anges i rubriken till en Creative Commons Publik Licens. Grundlicenser för denna Publika Licens är ”Erkännande” och ”DelaPåSammaVillkor”.  

1. **Med Licensmaterialet** avses det konstnärliga eller litterära verk, databas, eller annat material som Licensgivaren tillämpat denna Publika Licens för.

1. **Med Licensrättigheter** avses de rättigheter som Du beviljas enligt villkoren i denna Publika Licens, vilka är begränsade till all Upphovsrätt eller Liknande rättigheter som gäller för Din användning av Licensmaterialet och som Licensgivaren har behörighet att licensiera.  

1. **Med Licensgivaren** avses den fysiska eller juridiska person som beviljar rättigheter enligt denna Publika Licens.  

1. **Med Dela** avses att tillhandahålla material till allmänheten på alla sätt och vis som kräver tillstånd enligt Licensrättigheterna, såsom mångfaldigande, offentlig visning, offentligt framförande, distribution, spridning, kommunikation, eller import, och att göra materialet tillgängligt för allmänheten även på de sätt som medlemmar av allmänheten kan få tillgång till material från en plats och vid en tidpunkt som de väljer själva.  
...
1. **Med Du** avses den fysiska eller juridiska person som utövar Licensrättigheterna enligt denna Publika Licens. Din, Ditt eller Dina har motsvarande betydelse. **Dig** har en liknande betydelse.  
...
1. **Tillstånd enligt licens**.  
    1. Med förbehåll för villkoren i denna Publika Licens, beviljar Licenstagaren en global, royalty-fri, icke-vidarelicensierbar, icke-exklusiv och oåterkallelig rätt att nyttja Licensrättigheterna i Licensmaterialet till att:  
        ...
        1. skapa, mångfaldiga och Dela Bearbetningar.  
    ...
    1. **Senare nyttjare**.  
         ...
         1.  **Tilläggserbjudande från Licensgivaren -- Bearbetningar**. Varje mottagare av Bearbetningar från Dig får automatiskt ett erbjudande från Licensgivaren att nyttja Licensrättigheterna som hör till Bearbetningen enligt villkoren i Bearbetningslicensen som Du tillämpar.
    ...
    1. **Inget godkännande**. Ingenting i denna Publika Licens utgör eller kan tolkas som tillstånd för att hävda eller antyda att Du eller Din användning av Licensmaterialet hör samman med eller är sponsrad, godkänd, eller beviljad officiell status av Licensgivaren eller andra som har rätt till erkännande enligt avsnitt [3(1)(i)(a)(a)](Licens.md#avsnitt-3---licensvillkor).  
...
1. **Erkännande**.  
    1. Om Du Delar Licensmaterialet (inclusive i ändrad form), måste Du:  
        1. behålla följande om det tillhandahålls av Licensgivaren tillsammans med Licensmaterialet:  
            ...
            1. ett meddelande om upphovsrätt;   
            1. ett meddelande som hänvisar till denna Publika Licens;  
            1. ett meddelande som hänvisar till friskrivning från garantier;  
    ...
    1. Du kan uppfylla villkoren i avsnitt [3(1)(i)](Licens.md#avsnitt-3---licensvillkor) på varje rimligt sätt med tanke på det medium, sätt och sammanhang i vilket Du Delar Licensmaterialet. Till exempel kan det vara rimligt att uppfylla villkoren genom att tillhandahålla en URI eller hyperlänk till en resurs som innehåller den information som krävs.  
    1. På begäran av Licensgivaren måste Du, i den mån det är rimligt genomförbart, avlägsna sådan information som krävs enligt avsnitt [3(1)(i)(a)](Licens.md#avsnitt-3---licensvillkor).  
    
1. **DelaPåSammaVillkor**.  
    Om Du Delar de Bearbetningar Du har skapat gäller även följande villkor som tillägg till villkoren i avsnitt [3(1)](Licens.md#avsnitt-3---licensvillkor).  
...
1. för undvikande av missförstånd: avsnitt [2(1)(i)](Licens.md#avsnitt-2--omfattning) ger Dig rätt att extrahera, återanvända, mångfaldiga och Dela hela eller en väsentlig del av innehållet i databasen;  
1. om Du inkluderar hela eller en väsentlig del av databasinnehållet i en databas där Du har egna Sui generis-rättigheter för databasen, då är den databas som Du har Sui generis-rättigheter till (men inte dess innehåll) att betrakta som en Bearbetning, även vid tillämpning av avsnitt [3(2)](Licens.md#avsnitt-3---licensvillkor); och  
1. Du måste uppfylla villkoren i avsnitt [3(1)](Licens.md#avsnitt-3---licensvillkor) om Du Delar hela eller en väsentlig del av innehållet i databasen.  

För undvikande av missförstånd: detta avsnitt [4](Licens.md#avsnitt-4--sui-generis-rättigheter-för-databaser) kompletterar och ersätter inte Dina skyldigheter enligt denna Publika Licens när Licensrättigheterna inkluderar annan Upphovsrätt eller Liknande rättigheter.  
...
1. Om Din rätt att använda Licensmaterialet har upphört enligt [6(1)](Licens.md#avsnitt-6--giltighetstid-och-uppsägning), återinförs den:
    ...
    1. vid uttryckligt återinförande av Licensgivaren.För undvikande av missförstånd: detta avsnitt [6(2)](Licens.md#avsnitt-6--giltighetstid-och-uppsägning) påverkar inte den rätt Licensgivaren kan ha att beivra Din kränkning av denna Publika Licens.  
...
1. Avsnitten [1](Licens.md#avsnitt-1--definitioner), [5](Licens.md#avsnitt-5---friskrivning-från-utfästelser-och-begränsning-av-ansvar), [6](Licens.md#avsnitt-6--giltighetstid-och-uppsägning), [7](Licens.md#avsnitt-7--Övriga-villkor), och [8](Licens.md#avsnitt-8--tolkning) gäller fortsatt även efter upphörandet av denna Publika Licens.  
...
1. Alla överenskommelser, uppgörelser eller avtal om Licensmaterialet som inte anges här är skilda från och oberoende av villkoren i denna Publika Licens.  
